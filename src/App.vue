...
<template>
  <div class="bg-fuchsia-600 h-80">
    <svg width="100%" height="60%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
              fill-rule: evenodd;
              clip-rule: evenodd;
          ...
          <h1 class="text-5xl text-center font-bold"> ¿Cómo sabrás hasta donde puedes llegar si nunca lo has intentado? </h1>
  </div>
  <div class="h-64 bg-yellow-300 grid grid-cols-2 gap-2">
    <div class=" text-center p-4 text-4xl font-bold">¿Tienes una idea innovadora?<br> o <br> ¿No sabes por donde comenzar? <br> pero mas importante <br> ¿Eres estudiante de ISC? </div>
    <div class="text-center mt-16 py-4 text-3xl font-bolder"> No busques mas, encuentra ese apoyo aqui con los maestros capacitados en el area que necesites</div>
  </div>
  <div class=" text-center p-4 text-4xl font-bold bg-blue-400">¿Quienes somos?
       <div class="text-center mt-4 py-4 text-2xl font-bolder">Nosotros somos los maestros encargados de guiar y apoyar en la medida de lo posible los proyectos. Y si no podemos, te canalizamos con alguien que te responda tu duda<br>Desarrollamos aplicaciones con fines de práctica, investigación y responsabilidad social.
       Buscamos el desarrollo de nuestros estudiantes a través de la creación de proyectos que sean útiles a la sociedad.<br></div>
  </div>
  <div class=" text-center p-4 text-4xl font-bold bg-orange-300"> ¿Qué clase de proyectos realizamos?
    <div class="md:flex md:gap-4 text-left m-t=9">
          <div class="mb-5 bg-[#FB8500] md:w-1/2  md:flex md:items-start md:gap-4 px-10 py-7">
            <img src="img/svg/sitweb.svg" alt="sitio web" class="w-36 float-left mr-5">
            <div class="">
              <h3 class="text-3xl font-bold border-b-2 border-[#FB8500]">
                Sitio web
              </h3>
              <p class="mb-3 text-xl md:text-2xl">
                Los sitios web son lo que conocemos comúnmente por
                <span class="italic">"página web"</span>.
              </p>
              <p class="mb-2 text-xl md:text-2xl">Es la solución adecuada para:</p>
              <ul class="ml-11 list-disc text-xl">
          ...
          <div class="mb-5 bg-[#FB8500] md:w-1/2  md:flex md:items-start md:gap-4 px-10 py-7">
            ...
            <div class="">
              ...
              <p class="mb-3 text-xl md:text-2xl">
                Son como los sitios web, pero estos además pueden
                <span class="italic">manipular datos</span>.
              </p>
              <p class="mb-2 text-xl md:text-2xl">Es la solución adecuada para:</p>
              <ul class="ml-11 list-disc text-xl">
  ...
  <div class=" text-center p-4 text-2xl font-bold bg-orange-300"> Contacto: yasif.19070002@itsmotul.edu.mx
  </div>
</template>
